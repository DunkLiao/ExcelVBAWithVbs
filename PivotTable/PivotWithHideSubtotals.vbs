' ============================================================
' PivotWithHideSubtotals.vbs
' 說明：使用 VBScript 自動建立隱藏所有小計的樞紐分析表
' 功能：
'   1. 開啟 Excel 並建立新活頁簿
...
'   5. 同時隱藏總計列
'   6. 將結果儲存至桌面
' 執行方式：在命令提示字元輸入  cscript PivotTable\PivotWithHideSubtotals.vbs
' ============================================================

Option Explicit

' ── 常數設定 ────────────────────────────────────────────────
Const SHEET_DATA  = "薪資資料"
Const SHEET_PIVOT = "樞紐分析表"
Const PIVOT_NAME  = "隱藏小計樞紐"
Const OUTPUT_FILE = "16_PivotWithHideSubtotals.xlsx"
...
Dim arrNoSubtotals(11)
Dim savePath, objShell, i, j
