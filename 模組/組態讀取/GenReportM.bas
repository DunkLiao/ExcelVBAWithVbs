...
'將產生結果另存新檔
Public Function SaveReportToNewFile1()
'另存新檔
On Error GoTo ERRORHANDLE6
Application.DisplayAlerts = False
 Call FileSave.SaveAllSheetToNewFile("D:\AAB.xls")
Application.DisplayAlerts = True
GoTo ALLOK
 
ERRORHANDLE6:
    SaveReportToNewFile1 = "另存新檔發生錯誤!"
ALLOK:
    SaveReportToNewFile1 = "Finish!"
End Function
