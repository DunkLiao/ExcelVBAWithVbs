Attribute VB_Name = "CreateColumn3DChart"
' ============================================================
' CreateColumn3DChart.bas
' 說明：使用 Excel VBA 自動建立 3D 群組直條圖範例
' 功能：
'   1. 建立新活頁簿
'   2. 在工作表填入示範資料（季度銷售比較）
'   3. 插入 3D 群組直條圖
...
'   5. 將結果儲存至桌面
' 執行方式：在 Excel VBA 編輯器中執行 CreateColumn3DChart 巨集
' ============================================================

Option Explicit

' ── 常數設定 ────────────────────────────────────────────────
Const CHART_TITLE  As String = "2025 年季度銷售比較（3D）"
Const X_AXIS_TITLE As String = "季度"
Const Y_AXIS_TITLE As String = "銷售額（萬元）"
Const SHEET_NAME   As String = "季度銷售"
Const OUTPUT_FILE  As String = "Column3DChartExample.xlsx"

Sub CreateColumn3DChart()

    ' ── 範例資料 ────────────────────────────────────────────────
    ' 欄位：季度, 線上銷售, 實體門市
    Dim arrRows(3, 2) As Variant
