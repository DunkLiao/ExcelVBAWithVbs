Attribute VB_Name = "PivotWithDifferenceFrom"
' ============================================================
' PivotWithDifferenceFrom.bas
' 說明：使用 Excel VBA 自動建立顯示差異值的樞紐分析表
' 功能：
'   1. 建立新活頁簿
...
'   5. 將結果儲存至桌面
' 執行方式：在 Excel VBA 編輯器中執行 PivotWithDifferenceFrom 巨集
' ============================================================

Option Explicit

' ── 常數設定 ────────────────────────────────────────────────
Const SHEET_DATA  As String = "年度業績"
Const SHEET_PIVOT As String = "樞紐分析表"
Const PIVOT_NAME  As String = "差異值樞紐"
Const OUTPUT_FILE As String = "13_PivotWithDifferenceFrom.xlsx"

Sub PivotWithDifferenceFrom()

    ' ── 範例資料（年度、產品線、銷售額）────────────────────────
    Dim arrYears(17)   As Long
    Dim arrLines(17)   As String
    Dim arrAmounts(17) As Long
