Attribute VB_Name = "PivotWithGrouping"
' ============================================================
' PivotWithGrouping.bas
' 說明：使用 Excel VBA 自動建立含數值群組功能的樞紐分析表
' 功能：
'   1. 建立新活頁簿
'   2. 在「月份業績」工作表填入 12 個月份的銷售示範資料
'   3. 建立樞紐分析表後，將月份欄位（數值 1-12）群組為每季（步距 3）
'   4. 將結果儲存至桌面
' 執行方式：在 Excel VBA 編輯器中執行 PivotWithGrouping 巨集
' ============================================================

Option Explicit

' ── 常數設定 ────────────────────────────────────────────────
Const SHEET_DATA  As String = "月份業績"
Const SHEET_PIVOT As String = "樞紐分析表"
Const PIVOT_NAME  As String = "月份群組樞紐"
Const OUTPUT_FILE As String = "03_PivotWithGrouping.xlsx"

Sub PivotWithGrouping()
