Attribute VB_Name = "PivotWithFilter"
' ============================================================
' PivotWithFilter.bas
' 說明：使用 Excel VBA 自動建立含報表篩選頁面的樞紐分析表
' 功能：
'   1. 建立新活頁簿
'   2. 在「業績資料」工作表填入年度銷售示範資料
'   3. 建立樞紐分析表，篩選頁=年度，列=月份，欄=產品，值=銷售額
'   4. 將結果儲存至桌面
' 執行方式：在 Excel VBA 編輯器中執行 PivotWithFilter 巨集
' ============================================================
...
Const PIVOT_NAME  As String = "年度篩選樞紐"
Const OUTPUT_FILE As String = "02_PivotWithFilter.xlsx"

Sub PivotWithFilter()

    ' ── 範例資料（年度、月份、產品、銷售額）──────────────────────
    ' 2024 年 1-6 月 × 2 產品 = 12 筆，2025 年 1-6 月 × 2 產品 = 12 筆
    Dim arrYears(23)    As Long
